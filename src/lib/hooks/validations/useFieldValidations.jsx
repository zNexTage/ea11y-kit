...
const useFieldValidations = (label, id) => {
    ...
    useEffect(() => {
        ...
        if (!label) {
            ...
            errorsAux.push(new GuidelineViolation(ASSOCIATE_TAGS_WITH_YOUR_FIELDS, "É crucial que todos os campos de entrada, como caixas de texto, caixas de seleção (checkbox), botões de rádio (radio button), entre outros, tenham uma etiqueta (label) associada. A etiqueta fornece uma descrição clara do propósito do campo, o que é essencial para guiar todos os usuários, especialmente aqueles com dificuldades visuais que dependem de leitores de tela. Quando os usuários focam em um campo de entrada, o leitor de tela deve ler a etiqueta para fornecer a orientação adequada."));           
        }
